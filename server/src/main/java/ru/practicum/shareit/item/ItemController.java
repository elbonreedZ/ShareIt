...
public class ItemController {
    ...
    ItemDto create(@RequestBody ItemCreateDto itemCreateDto, @RequestHeader("X-Sharer-User-Id") long ownerId) {
    ...
    ItemDto update(@RequestBody ItemUpdateDto itemUpdateDto, @RequestHeader("X-Sharer-User-Id") long ownerId, @PathVariable long id) {
